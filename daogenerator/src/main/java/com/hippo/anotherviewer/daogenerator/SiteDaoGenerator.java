...
package com.hippo.anotherviewer.daogenerator;
...
public class SiteDaoGenerator {

    private static final String PACKAGE = "com.hippo.anotherviewer.dao";
    ...
    private static final String QUICK_SEARCH_PATH = OUT_DIR+"/com/hippo/anotherviewer/dao/QuickSearch.java";
    private static final String LOCAL_FAVORITE_INFO_PATH = OUT_DIR+"/com/hippo/anotherviewer/dao/LocalFavoriteInfo.java";
    private static final String BOOKMARK_INFO_PATH = OUT_DIR+"/com/hippo/anotherviewer/dao/BookmarkInfo.java";
    private static final String FILTER_PATH = OUT_DIR+"/com/hippo/anotherviewer/dao/Filter.java";
    private static final String BLACKLIST_PATH = OUT_DIR+"/com/hippo/anotherviewer/dao/BlackList.java";
    private static final String GALLERY_TAG_PATH = OUT_DIR+"/com/hippo/anotherviewer/dao/GalleryTags.java";
    ...
    private static void adjustDownloadInfo() throws Exception {
        ...
        javaClass.addMethod("public void updateInfo(GalleryInfo galleryInfo) {\n" +
                ...
                "\t\tthis.simpleLanguage = galleryInfo.simpleLanguage;\n" +
                "\t}");
        javaClass.addImport("com.hippo.anotherviewer.client.data.GalleryInfo");
