...
/**
 * Runtime-mutable outbound proxy configuration for all E-Hentai traffic.
 *
 * The server fetches galleries / images from E-Hentai through the shared
 * [EhSessionManager.okHttpClient]. OkHttp consults a [ProxySelector] and an
