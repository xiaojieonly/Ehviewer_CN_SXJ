...
import com.hippo.ehviewer.web.eq
...
class PrefetchServiceTest {
    ...
    private lateinit var sessionManager: EhSessionManager
    ...
    fun setUp() {
        ...
        sessionManager = mock(EhSessionManager::class.java)
        ...
        `when`(galleryLookup.fetchImageUrl(anyLong(), anyString(), anyInt()))
            .thenReturn("https://ehgt.org/example/image.jpg")
    ...
    fun `prefetch is bounded by the executor thread pool`() {
        ...
        `when`(galleryLookup.fetchImageUrl(anyLong(), anyString(), anyInt())).thenAnswer {
            ...
            "https://ehgt.org/example/image.jpg"
        }
