...
public class EhDns implements Dns {
    ...
    static {
        ...
        if (Settings.getBuiltEXHosts()) {
            put(map, "exhentai.org", "178.175.128.252", "178.175.129.252", "178.175.129.254", "178.175.128.254", "178.175.132.20", "178.175.132.22", "172.64.206.24", "172.64.207.24");
    ...
    public EhDns(Context context) {
        ...
        DnsOverHttps.Builder builder = new DnsOverHttps.Builder().client(new OkHttpClient.Builder().cache(EhApplication.getOkHttpCache(context)).build()).url(HttpUrl.get("https://cloudflare-dns.com/dns-query"));
        try {
