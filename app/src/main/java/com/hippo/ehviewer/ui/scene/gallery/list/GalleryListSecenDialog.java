...
public class GalleryListSecenDialog {
    ...
    public void showTagLongPressDialog() {
        ...
        new AlertDialog.Builder(context).setTitle(tagName).setItems(R.array.tag_menu_entries, (dialog, which) -> {
            switch(which) {
                case 0:
        ...
        }).setNegativeButton(R.string.copy_tag, (dialog, which) -> copyTag(tagName)).show();
    }
    ...
    public void showFilterTagDialog() {
        ...
        new AlertDialog.Builder(context).setMessage(context.getString(R.string.filter_the_tag, tagName)).setPositiveButton(android.R.string.ok, (dialog, which) -> {
