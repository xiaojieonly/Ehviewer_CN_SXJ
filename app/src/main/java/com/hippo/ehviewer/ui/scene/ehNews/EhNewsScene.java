...
public class EhNewsScene extends BaseScene {
    ...
    private void loadData() {
        ...
        EhRequest request = new EhRequest().setMethod(EhClient.METHOD_GET_NEWS).setArgs(url).setCallback(new EhNewsDetailListener(mContext, activity.getStageId(), getTag()));
