...
public class EhDistributeListener implements DistributeListener {
    ...
    public boolean onReleaseAvailable(Activity activity, ReleaseDetails releaseDetails) {
        ...
        // you should use a string resource instead, this is just a simple example
        ...
        // if it's cancelable you should map cancel to postpone, but only for optional updates
