...
public class Hosts {
    ...
    public Hosts(Context context, String name) {
        helper = new MSQLiteBuilder().version(VERSION_1).createTable(TABLE_HOSTS).insertColumn(TABLE_HOSTS, COLUMN_HOST, String.class).insertColumn(TABLE_HOSTS, COLUMN_IP, String.class).build(context, name, DB_VERSION);
