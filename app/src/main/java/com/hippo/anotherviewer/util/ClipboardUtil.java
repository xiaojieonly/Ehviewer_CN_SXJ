...
public class ClipboardUtil {
    ...
    public static void copy(GalleryInfo galleryInfo) {
        ...
        if (!TextUtils.isEmpty(content)) {
            // 得到剪贴板管理器
            ClipboardManager cmb = (ClipboardManager) SiteApplication.getInstance().getSystemService(Context.CLIPBOARD_SERVICE);
...
//        return c;
    ...
    private static void clearClipboard() {
        ClipboardManager manager = (ClipboardManager) SiteApplication.getInstance().getSystemService(Context.CLIPBOARD_SERVICE);
        if (manager != null) {
            try {
