...
public class DownloadLabelsScene extends ToolbarScene {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mList = SiteApplication.getDownloadManager(getEHContext()).getLabelList();
    }
    ...
    private class NewLabelDialogHelper implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            } else if (SiteApplication.getDownloadManager(context).containLabel(text)) {
                mBuilder.setError(getString(R.string.label_text_exist));
            } else {
                mBuilder.setError(null);
                mDialog.dismiss();
                SiteApplication.getDownloadManager(context).addLabel(text);
    ...
    private class RenameLabelDialogHelper implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (TextUtils.isEmpty(text)) {
                ...
                mBuilder.setError(null);
                mDialog.dismiss();
                SiteApplication.getDownloadManager(context).renameLabel(mOriginalLabel, text);
                if (mAdapter != null) {
                ...
                new AlertDialog.Builder(context)
                    ...
                    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            SiteApplication.getDownloadManager(context).deleteLabel(label.getLabel());
                        }
                    })
    ...
    private class LabelAdapter extends RecyclerView.Adapter<LabelHolder>
        ...
        public void onMoveItem(int fromPosition, int toPosition) {
            ...
            SiteApplication.getDownloadManager(context).moveLabel(fromPosition, toPosition);
        }
