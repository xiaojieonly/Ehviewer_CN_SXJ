...
import static com.hippo.anotherviewer.client.wifi.ConnectThread.DEVICE_CONNECTING;
...
import static com.hippo.anotherviewer.client.wifi.ConnectThread.GET_DIR_ACK;
import static com.hippo.anotherviewer.client.wifi.ConnectThread.IS_SERVER;
...
import com.hippo.anotherviewer.client.wifi.WiFiFrame;
import com.hippo.anotherviewer.client.wifi.WiFiFrameCodec;
...
import com.hippo.anotherviewer.ui.ToolbarActivity;
...
public class WiFiServerActivity extends ToolbarActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void createFavoriteData() {
        List<GalleryInfo> list = SiteDB.getAllLocalFavorites();
        new Thread(() -> {
            int pageSize = 10;
    ...
    private void createBookmarkData() {
        List<QuickSearch> list = SiteDB.getAllQuickSearch();
        new Thread(() -> {
            int pageSize = 10;
            int pageCount = totalPage(list.size(), pageSize);
    ...
    private void createDownloadData() {
        new Thread(() -> {
            ...
            List<DownloadInfo> allInfo = SiteDB.getAllDownloadInfo();
