...
class UpdateDialog(private val activity: Activity) {
    companion object {
        const val GITHUB_RELEASE_URL = "https://github.com/xiaojieonly/Anotherviewer_CN_SXJ/releases"
        const val GITHUB_README_URL =
            "https://github.com/xiaojieonly/Anotherviewer_CN_SXJ/blob/BiLi_PC_Gamer/README.md"
...
//                        gotoGithub(dialog, id)
    ...
    private fun downloadApk(
        ...
        dialog?.dismiss()
//        val title = "Anotherviewer$version.apk"
...
//            SiteConfig.UPDATE_PATH + title + ".apk"
//        )
...
//           try {
//               lock.tryLock()
//               val file =File(Environment.DIRECTORY_DOWNLOADS+"/"+SiteConfig.UPDATE_PATH + title + ".apk")
//               if (save(SiteApplication.getOkHttpClient(activity),downloadUrl,file)){
//                   installApp(file)
//               }else{
//                   showCheckFailDialog()
//               }
...
//        val request = Request.Builder().url(url).build()
        val request = SiteRequestBuilder(url, null, null).get().build()
