...
public abstract class SiteActivity extends AppCompatActivity {
...
//        setTheme(getThemeResId(Settings.getTheme(context)));
        ...
        ((SiteApplication) getApplication()).registerActivity(this);
    ...
    protected void onDestroy() {
        ...
        ((SiteApplication) getApplication()).unregisterActivity(this);
    }
