package com.hippo.anotherviewer.ui.wifi;

import static com.hippo.anotherviewer.client.wifi.ConnectThread.DATA_TYPE_DOWNLOAD_INFO;
import static com.hippo.anotherviewer.client.wifi.ConnectThread.DATA_TYPE_DOWNLOAD_LABEL;
import static com.hippo.anotherviewer.client.wifi.ConnectThread.DATA_TYPE_FAVORITE_INFO;
import static com.hippo.anotherviewer.client.wifi.ConnectThread.DATA_TYPE_QUICK_SEARCH;
import static com.hippo.anotherviewer.client.wifi.ConnectThread.DEVICE_CONNECTED;
import static com.hippo.anotherviewer.client.wifi.ConnectThread.DEVICE_DISCONNECTED;
import static com.hippo.anotherviewer.client.wifi.ConnectThread.DOWNLOAD_INFO_DATA_KEY;
import static com.hippo.anotherviewer.client.wifi.ConnectThread.DOWNLOAD_LABEL_KEY;
import static com.hippo.anotherviewer.client.wifi.ConnectThread.FAVORITE_INFO_DATA_KEY;
import static com.hippo.anotherviewer.client.wifi.ConnectThread.GET_DIR_MANIFEST;
import static com.hippo.anotherviewer.client.wifi.ConnectThread.GET_FILE_CHUNK;
import static com.hippo.anotherviewer.client.wifi.ConnectThread.GET_MSG;
import static com.hippo.anotherviewer.client.wifi.ConnectThread.IS_CLIENT;
import static com.hippo.anotherviewer.client.wifi.ConnectThread.QUICK_SEARCH_DATA_KEY;
import static com.hippo.anotherviewer.client.wifi.ConnectThread.SEND_MSG_ERROR;
import static com.hippo.anotherviewer.client.wifi.ConnectThread.SEND_MSG_SUCCESS;
import static com.hippo.anotherviewer.event.SomethingNeedRefresh.bookmarkDrawNeedRefresh;
import static com.hippo.anotherviewer.event.SomethingNeedRefresh.downloadInfoNeedRefresh;
...
import com.hippo.anotherviewer.client.data.wifi.WiFiDataHand;
import com.hippo.anotherviewer.client.wifi.ConnectThread;
import com.hippo.anotherviewer.client.wifi.ListenerThread;
import com.hippo.anotherviewer.client.wifi.WiFiDownloadMigrationHelper;
...
public class WiFiClientActivity extends AppCompatActivity {
    ...
    private void dealWithFavoriteInfo(WiFiDataHand response) {
        ...
        new Thread(()->{
            for (int i = 0; i < jsonArray.size(); i++) {
                SiteDB.putLocalFavorite(GalleryInfo.galleryInfoFromJson(jsonArray.getJSONObject(i)));
            }
            connectThread.dataProcessed(response);
    ...
    private void dealWithDownloadInfo(WiFiDataHand response) {
        ...
        DownloadManager manager = SiteApplication.getDownloadManager();
        new Thread(()->{
            for (int i = 0; i < jsonArray.size(); i++) {
               try{
    ...
    private void dealWithQuickSearch(WiFiDataHand response) {
        ...
        new Thread(()->{
            SiteDB.takeOverQuickSearchList(quickSearchList);
            connectThread.dataProcessed(response);
            updateReceiveMessage(getString(R.string.wifi_server_receive_message, response.toString()));
