...
public abstract class SiteCallback<E extends SceneFragment, T> implements SiteClient.Callback<T>  {

    private final SiteApplication mApplication;
    private final int mStageId;
    private final String mSceneTag;

    public SiteCallback(Context context, int stageId, String sceneTag) {
