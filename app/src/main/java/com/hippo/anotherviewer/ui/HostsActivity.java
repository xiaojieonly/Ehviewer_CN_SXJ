...
public class HostsActivity extends ToolbarActivity
  ...
  private static final String KEY_HOST = "com.hippo.anotherviewer.ui.HostsActivity.HOST";
  private static final String KEY_IP = "com.hippo.anotherviewer.ui.HostsActivity.IP";
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    hosts = SiteApplication.getHosts(this);
    data = hosts.getAll();
