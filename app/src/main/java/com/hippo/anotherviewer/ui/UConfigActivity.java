...
import com.hippo.anotherviewer.widget.DialogWebChromeClient;
...
public class UConfigActivity extends ToolbarActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (okHttpClient == null) {
            okHttpClient = SiteApplication.getOkHttpClient(getApplicationContext());
        }
        ...
        try {
            ...
            url = SiteUrl.getUConfigUrl();
            SiteCookieStore store = SiteApplication.getSiteCookieStore(this);
...
//        webView.addJavascriptInterface(payloadRecorder, "recorder");
    ...
    protected void onDestroy() {
        ...
        try {
            ...
            if (cookiesString != null && !cookiesString.isEmpty()) {
                SiteCookieStore store = SiteApplication.getSiteCookieStore(this);
                HttpUrl eUrl = HttpUrl.parse(SiteUrl.HOST_E);
                HttpUrl exUrl = HttpUrl.parse(SiteUrl.HOST_EX);
    ...
    private class UConfigWebViewClient extends RequestInspectorWebViewClient {
        ...
        public WebResourceResponse shouldInterceptRequest(WebView view, WebViewRequest request) {
            Request okRequest;
            SiteRequestBuilder builder = new SiteRequestBuilder(request.getHeaders(),
                    request.getUrl());
