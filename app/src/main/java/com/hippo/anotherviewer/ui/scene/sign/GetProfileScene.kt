...
import com.hippo.anotherviewer.ui.scene.sign.SignInScene.AVATAR
import com.hippo.anotherviewer.ui.scene.sign.SignInScene.DISPLAY_NAME
...
//                        "return JSON.stringify(content);" +
    ...
    private inner class ProfileWebViewClientSNI : RequestInspectorWebViewClient {
        ...
        override fun shouldInterceptRequest(
            ...
            val builder = SiteRequestBuilder(
                request.headers,
                request.url
            )
