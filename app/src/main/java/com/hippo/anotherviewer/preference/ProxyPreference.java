...
import com.hippo.anotherviewer.SiteProxySelector;
...
public class ProxyPreference extends DialogPreference implements View.OnClickListener {
    ...
    private void updateSummary(int type, String ip, int port) {
        if ((type == SiteProxySelector.TYPE_HTTP || type == SiteProxySelector.TYPE_SOCKS)
                && (TextUtils.isEmpty(ip) || !InetValidator.isValidInetPort(port)) ) {
            type = SiteProxySelector.TYPE_SYSTEM;
        }
    ...
    public void onClick(View v) {
        ...
        SiteApplication.getSiteProxySelector(getContext()).updateProxy();
