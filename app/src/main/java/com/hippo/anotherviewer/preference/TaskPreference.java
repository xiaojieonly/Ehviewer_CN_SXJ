...
public abstract class TaskPreference extends DialogPreference {
    ...
    protected void onDialogCreated(AlertDialog dialog) {
        if (null == mTask) {
            ...
            mTaskId = ((SiteApplication) getContext().getApplicationContext()).putGlobalStuff(mTask);
...
//    }
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        if (IntIdGenerator.INVALID_ID != mTaskId) {
            Object o = ((SiteApplication) getContext().getApplicationContext()).getGlobalStuff(mTaskId);
    ...
    public abstract static class Task extends AsyncTask<Void, int[], Object> {
        ...
        public Task(@NonNull Context context) {
            mApplication = (SiteApplication) context.getApplicationContext();
        }
