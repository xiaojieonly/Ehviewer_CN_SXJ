...
public class LargePreviewSet extends PreviewSet {
    ...
    public GalleryPreview getGalleryPreview(long gid, int index) {
        ...
        galleryPreview.imageKey = SiteCacheKeyFactory.getLargePreviewKey(gid, galleryPreview.position);
    ...
    public void load(LoadImageView view, long gid, int index) {
        view.resetClip();
        view.load(SiteCacheKeyFactory.getLargePreviewKey(gid, mPositionList.get(index)),
