...
public class SiteRequestBuilder extends ChromeRequestBuilder {

    public SiteRequestBuilder(String url) {
        this(url, null, null);
    }

    public SiteRequestBuilder(String url, String referer) {
    ...
    public SiteRequestBuilder(Map<String, String> headers,String url ) {
        super(url);
