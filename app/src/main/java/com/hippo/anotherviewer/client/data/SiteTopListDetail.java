...
public class SiteTopListDetail implements Parcelable {
    ...
    public SiteTopListDetail(){
        classLoader = TopListInfo.class.getClassLoader();
    }

    protected SiteTopListDetail(Parcel in) {
    ...
    public static final Creator<SiteTopListDetail> CREATOR = new Creator<SiteTopListDetail>() {
        @Override
        public SiteTopListDetail createFromParcel(Parcel in) {
            return new SiteTopListDetail(in);
        }

        @Override
        public SiteTopListDetail[] newArray(int size) {
            return new SiteTopListDetail[size];
        }
    };
