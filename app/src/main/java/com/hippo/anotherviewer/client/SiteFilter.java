...
public final class SiteFilter {
    ...
    private static final String TAG = SiteFilter.class.getSimpleName();
    ...
    private static SiteFilter sInstance;

    public static SiteFilter getInstance() {
        if (sInstance == null) {
            sInstance = new SiteFilter();
        }
        return sInstance;
    }

    private SiteFilter() {
        List<Filter> list = SiteDB.getAllFilter();
