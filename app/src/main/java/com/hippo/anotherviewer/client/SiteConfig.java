...
public class SiteConfig implements Cloneable {
    ...
    public static final String UPDATE_PATH = "Anotherviewer/Update/";
    public static final String ARCHIVER_PATH = "Anotherviewer/Archiver/";
    public static final String TORRENT_PATH = "Anotherviewer/Torrent/";
