 ...
 * {@link com.hippo.anotherviewer.SiteApplication#getOkHttpClient}: that client is tuned
...
public final class WebUiApiClient {
     ...
     * server's index. Used by {@link com.hippo.anotherviewer.gallery.WebUiGalleryProvider}
