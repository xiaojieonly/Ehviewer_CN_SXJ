...
@CoordinatorLayout.DefaultBehavior(SiteDrawerLayout.Behavior.class)
public class SiteDrawerLayout extends DrawerLayout {

    private List<View> mAboveSnackViewList;

    public SiteDrawerLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SiteDrawerLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public static class Behavior extends CoordinatorLayout.Behavior<SiteDrawerLayout> {
        ...
        public boolean layoutDependsOn(CoordinatorLayout parent,
                SiteDrawerLayout child, View dependency) {
            // We're dependent on all SnackbarLayouts (if enabled)
            return SNACKBAR_BEHAVIOR_ENABLED && dependency instanceof Snackbar.SnackbarLayout;
        }

        @Override
        public boolean onDependentViewChanged(CoordinatorLayout parent, SiteDrawerLayout child,
                View dependency) {
        ...
        private void updateChildTranslationForSnackbar(CoordinatorLayout parent,
                SiteDrawerLayout view, final View child) {
