...
public class SiteDrawerView extends DrawerView implements DrawerLayoutChild {

    private int mWindowPaddingTop;
    private int mWindowPaddingBottom;

    public SiteDrawerView(Context context) {
        super(context);
    }

    public SiteDrawerView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SiteDrawerView(Context context, AttributeSet attrs, int defStyleAttr) {
