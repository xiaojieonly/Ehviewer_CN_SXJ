...
public class SiteStageLayout extends StageLayout implements DrawerLayoutChild {

    private int mWindowPaddingTop;
    private int mWindowPaddingBottom;

    public SiteStageLayout(Context context) {
        super(context);
    }

    public SiteStageLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SiteStageLayout(Context context, AttributeSet attrs, int defStyleAttr) {
