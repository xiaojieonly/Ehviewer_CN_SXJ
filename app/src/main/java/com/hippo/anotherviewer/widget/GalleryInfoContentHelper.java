...
public abstract class GalleryInfoContentHelper extends ContentLayout.ContentHelper<GalleryInfo> {
  ...
  public GalleryInfoContentHelper() {
    ...
    SiteApplication.getFavouriteStatusRouter().addListener(listener);
  }

  public void destroy() {
    SiteApplication.getFavouriteStatusRouter().removeListener(listener);
  }
  ...
  protected Parcelable saveInstanceState(Parcelable superState) {
    ...
    FavouriteStatusRouter router = SiteApplication.getFavouriteStatusRouter();
