...
public class SiteNavigationView extends LinearLayout implements DrawerLayoutChild {
    ...
    public SiteNavigationView(Context context) {
        super(context);
        init();
    }

    public SiteNavigationView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public SiteNavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
