...
public class SiteGalleryProvider extends GalleryProvider2 implements SpiderQueen.OnSpiderListener {
    ...
    public SiteGalleryProvider(Context context, GalleryInfo galleryInfo) {
        mContext = context;
