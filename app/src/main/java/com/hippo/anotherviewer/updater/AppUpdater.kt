package com.hippo.anotherviewer.updater
...
import com.hippo.anotherviewer.ui.dialog.UpdateDialog
        ...
        fun update(activity: Activity, manualChecking: Boolean) {
            ...
            IoThreadPoolExecutor.instance.execute {
                ...
                try {
                    ...
                    val client =
                        SiteApplication.getOkHttpClient(SiteApplication.getInstance())
