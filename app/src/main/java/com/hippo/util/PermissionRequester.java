...
public class PermissionRequester {
    ...
    public static boolean request(final Activity activity, final String permission, String rationale, final int requestCode) {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(activity, permission)) {
            new AlertDialog.Builder(activity).setMessage(rationale).setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
     ...
     * false for do in {@link ActivityCompat.OnRequestPermissionsResultCallback#onRequestPermissionsResult(int, String[], int[])}
     */
    public static boolean request(final Activity activity, final String permission, String rationale, final int requestCode, PermissionCallBack permissionCallBack) {
        if (!(activity instanceof ActivityCompat.OnRequestPermissionsResultCallback)) {
            throw new IllegalStateException("The Activity must implement ActivityCompat.OnRequestPermissionsResultCallback");
        }
    ...
    private static boolean requestPermissions(final Activity activity, final String[] permissions, int requestCode) {
        try {
