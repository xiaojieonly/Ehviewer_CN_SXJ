...
class CookieDatabase {
    ...
    public void update(Cookie from, Cookie to) {
        ...
        if (from.name().equals("igneous") && Settings.getLockCookieIgneous()) {
            return;
        }
