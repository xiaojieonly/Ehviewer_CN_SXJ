...
public class SiteSSLSocketFactoryLowSDK extends SSLSocketFactory {

    private final SSLSocketFactory mSSLSocketFactory;

    public SiteSSLSocketFactoryLowSDK(SSLSocketFactory sslSocketFactory)  {
    ...
    public Socket createSocket(Socket s, String host, int port, boolean autoClose) throws IOException {
        ...
        Log.d("SiteSSLSocketFactory", "Host: " + host + " Address: " + address.getHostAddress());
