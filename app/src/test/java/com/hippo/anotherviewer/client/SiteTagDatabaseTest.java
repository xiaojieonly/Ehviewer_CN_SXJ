...
public class SiteTagDatabaseTest {

  @Test
  public void readTheList() throws IOException {
    InputStream resource = SiteTagDatabaseTest.class.getResourceAsStream("SiteTagDatabaseTest");

    SiteTagDatabase db;
    try (BufferedSource source = Okio.buffer(Okio.source(resource))) {
      db = new SiteTagDatabase("SiteTagDatabaseTest", source);
    }
