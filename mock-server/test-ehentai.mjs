// Automated tests for the E-Hentai mock server (ehentai.mjs).
//
// Run with:  node --test test-ehentai.mjs   (or: node test-ehentai.mjs)
...
//   - ehentai-fixtures.mjs  -> GALLERIES, findGallery, EXH_BASE
//   - ehentai-images.mjs    -> makeImage(gid, page, format)

import { test, before, after } from 'node:test';
import assert from 'node:assert/strict';
import express from 'express';
import ehentaiRoutes from './ehentai.mjs';
import { GALLERIES, findGallery } from './ehentai-fixtures.mjs';
