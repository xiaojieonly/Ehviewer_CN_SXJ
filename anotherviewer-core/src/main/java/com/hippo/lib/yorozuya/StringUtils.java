...
public final class StringUtils {
    ...
    private static String replaceEach(
        ...
        if (text == null || text == null || text.isEmpty() || searchList == null ||
        ...
        for (int i = 0; i < searchLength; i++) {
            if (noMoreMatchesForReplIndex[i] || searchList[i] == null ||
                    searchList[i] == null || searchList[i].isEmpty() || replacementList[i] == null) {
                continue;
            }
    ...
    public static String remove(String str, char[] removed) {
        if (str == null || str.isEmpty() || null == removed || 0 == removed.length) {
            return str;
        }
        ...
        for (int i = 0; i < chars.length; i++) {
            if (!containsChar(removed, chars[i])) {
                chars[pos++] = chars[i];
            }
        }
    ...
    private static boolean containsChar(char[] array, char value) {
        for (char c : array) {
