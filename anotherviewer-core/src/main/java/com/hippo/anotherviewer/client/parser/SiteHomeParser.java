...
public class SiteHomeParser {
    private static final Logger logger = LoggerFactory.getLogger(SiteHomeParser.class);
    private static final String TAG = "SiteHomeParser";
     ...
     */
    public static HomeDetail parse(String body) throws SiteException {
