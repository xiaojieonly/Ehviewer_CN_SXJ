...
import com.hippo.anotherviewer.sync.GalleryListTagsSyncTask;
...
public class GalleryListParser {
    private static final Logger logger = LoggerFactory.getLogger(GalleryListParser.class);
    ...
    public static Result parse(String body, int mode) throws Exception {
        Document d;
        try {
            d = Jsoup.parse(body);
    ...
    public static Result parse(Document d,String body, int mode) throws Exception {
...
//                throw new ParseException("No gallery", body);
    ...
    private static GalleryInfo parseGalleryInfo(Element e) {
        ...
        if (glThumb != null) {
            ...
            if (img != null) {
                ...
                if (m.find()) {
                    ...
                    logger.warn( "Can't parse gallery info thumb size");
                    gi.thumbWidth = 0;
                    gi.thumbHeight = 0;
                }
                // Thumb url
                ...
                gi.thumb = SiteUtils.handleThumbUrlResolution(url);
            }
        ...
        if (gi.thumb == null) {
            ...
            if (gl != null) {
                ...
                if (img != null) {
                    ...
                    gi.thumb = SiteUtils.handleThumbUrlResolution(img.attr("src"));
                }
            }
        }
        ...
        if (gi.favoriteSlot == -2) {
            gi.favoriteSlot = SiteDB.containLocalFavorites(gi.gid) ? -1 : -2;
        }
