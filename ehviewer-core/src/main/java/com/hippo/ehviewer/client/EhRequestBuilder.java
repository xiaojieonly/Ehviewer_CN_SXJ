 ...
 * fingerprint to E-Hentai: explicit Host, Chrome user agent, image-oriented
 * Accept and zh-CN Accept-Language. Keeping this in the shared core module
 * guarantees every upstream request built by {@link EhEngine} matches the
 * app's call pattern, whatever OkHttp client is used.
 */
public class EhRequestBuilder extends Request.Builder {
    ...
    public EhRequestBuilder(String url) { this(url, null, null); }
    public EhRequestBuilder post(RequestBody body) { super.post(body); return this; }
}
