...
import com.hippo.ehviewer.util.Pair;
...
//    https://e-hentai.org/g/2914213/fc8bce61d9/
    ...
    public static TorrentInfo[] getTorrentList(EhClient.Task task, OkHttpClient okHttpClient,
    ...
    public static EhTopListDetail getTopList(EhClient.Task task, OkHttpClient okHttpClient,
                                             String url) throws Throwable {
...
//        Request request = new EhRequestBuilder(url, referer).build();
    ...
    public static ArchiverData getArchiver(EhClient.Task task, OkHttpClient okHttpClient,
                                           String url, long gid, String token) throws Throwable {
        String referer = EhUrl.getGalleryDetailUrl(gid, token);
        logger.debug( url);
        Request request = new EhRequestBuilder(url, referer).build();
    ...
    public static String downloadArchiver(
            EhClient.Task task, OkHttpClient okHttpClient, String url, String referer, String dltype, String dlcheck)
            throws Throwable {
...
//            获取跳转链接
    ...
    public static UserTagList getWatchedList(EhClient.Task task,
...
//        return EhNewsParse.parse("");
    ...
    public static HomeDetail getHomeDetail(EhClient.Task task, OkHttpClient okHttpClient) throws Throwable {
        String referer = EhUrl.getReferer();
    ...
    public static HomeDetail resetLimit(EhClient.Task task, OkHttpClient okHttpClient) throws Throwable {
        FormBody.Builder builder = new FormBody.Builder();
